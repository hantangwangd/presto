        ...
        implements ConnectorTableHandle
{
    ...
    private final boolean specifiedSnapshot;
    ...
    public IcebergTableHandle(
            ...
            @JsonProperty("specifiedSnapshot") boolean specifiedSnapshot,
            @JsonProperty("predicate") TupleDomain<IcebergColumnHandle> predicate)
    {
        ...
        this.specifiedSnapshot = requireNonNull(specifiedSnapshot, "specifiedSnapshot is null");
    ...
    @JsonProperty
    public boolean isSpecifiedSnapshot()
    {
    ...
    public boolean equals(Object o)
    {
        ...
        return Objects.equals(schemaName, that.schemaName) &&
                ...
                specifiedSnapshot == that.specifiedSnapshot &&
    ...
    public int hashCode()
    {
        return Objects.hash(schemaName, tableName, tableType, snapshotId, specifiedSnapshot, predicate);
    }
